...
{
        this->window = new sf::RenderWindow(sf::VideoMode(800,600), "Starshooter", sf::Style::Close |sf::Style::Titlebar);
...
void Game::initGUI()
{
    ...
    this->playerHpBar.setFillColor(sf::Color(25,25,25,200));
}
...
void Game::updateCollision()
{
    ...
    {
        this->player->setPosistion(0.f,this->player->getBounds().top);
    }

    //right world collision
    else if(this->player->getBounds().left + this->player->getBounds().width >= this->window->getSize().x)
    {
        this->player->setPosistion(this->window->getSize().x - this->player->getBounds().width, this->player->getBounds().top);
    }
    ...
    {
        this->player->setPosistion(this->player->getBounds().left , 0.f);
    }

    //bottom world collision (needs fixing)
    else if(this->player->getBounds().top + this->player->getBounds().height >= this->window->getSize().y)
    {
        this->player->setPosistion(this->player->getBounds().left , this->window->getSize().y - this->player->getBounds().height);
    }
}
